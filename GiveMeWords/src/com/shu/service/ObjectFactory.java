 ...
 * generated in the com.shu.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _TransWords_QNAME = new QName("http://function.sullay.com/", "transWords");
    private final static QName _TransWordsResponse_QNAME = new QName("http://function.sullay.com/", "transWordsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.shu.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://function.sullay.com/", name = "transWords")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://function.sullay.com/", name = "transWordsResponse")
