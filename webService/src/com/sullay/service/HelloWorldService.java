 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://service.sullay.com/", wsdlLocation = "http://localhost:9001/Service/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://service.sullay.com/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9001/Service/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://service.sullay.com/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sullay.com/", "HelloWorldPort"), HelloWorld.class, features);
    }
