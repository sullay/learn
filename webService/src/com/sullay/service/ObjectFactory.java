 ...
 * generated in the com.sullay.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorldResponse_QNAME = new QName("http://service.sullay.com/", "helloWorldResponse");
    private final static QName _HelloWorld_QNAME = new QName("http://service.sullay.com/", "helloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sullay.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.sullay.com/", name = "helloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.sullay.com/", name = "helloWorld")
